...
// console.log('Age: ' + s3_age);

// let avg_grade_s1 = (student1[3][0] + student1[3][1] + student1[3][2]) / 3;
// let avg_grade_s2 = (student2[3][0] + student2[3][1] + student2[3][2]) / 3;
// let avg_grade_s3 = (student3[3][0] + student3[3][1] + student3[3][2]) / 3;

// console.log('Grade: ' + parseInt(avg_grade_s1));
...
// final_5 = user1.hobbies[1];


// console.log(users[1].address.state);
// console.log(final_5);
